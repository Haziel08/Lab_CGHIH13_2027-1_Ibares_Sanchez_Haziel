...
double tiempoInicio = glfwGetTime();
int i = 0; // Variable que usará el ciclo for
...
int main()
{
	...
	//CREAR VENTANA
	GLFWwindow *mainWindow = glfwCreateWindow(WIDTH, HEIGHT, "E01-320309203", NULL, NULL);
 ...
 //Llamada a las funciones creadas antes del main
	...
	while (!glfwWindowShouldClose(mainWindow))
	{
		...
		for (int i = 0; i < 3; i++)
		{
			...
			// Si se cierra la ventasa salir del for
